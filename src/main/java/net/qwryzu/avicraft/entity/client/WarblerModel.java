...
public class WarblerModel extends EntityModel<WarblerEntityRenderState> {
    ...
    @Override
    public void setAngles(WarblerEntityRenderState audubonsWarblerEntityRenderState) {
        super.setAngles(audubonsWarblerEntityRenderState);
        this.idleAnimation.apply(audubonsWarblerEntityRenderState.idleAnimationState, audubonsWarblerEntityRenderState.age);
        this.flappingAnimation.apply(audubonsWarblerEntityRenderState.flyingAnimationState, audubonsWarblerEntityRenderState.age);
    }
